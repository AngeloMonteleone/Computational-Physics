...
int main(int argc, char** argv){
  ...
  printInFile<ld,ld>("coef_unif" + to_string(esp) + ".dat",ascisse,current_moment_unif,15);
  printInFile<ld,ld>("coef_coin" + to_string(esp) + ".dat",ascisse,current_moment_coin,15);
  return 0;
}
