...
int main(int argc, char** argv){
    ...
    //     if((i%2)!=0){
    //         start = GET_TIME;
    //         simpson.push_back(fabs(REAL_VAL-int_simpson(i,a,b,&f3))); 
    ...
    //     start = GET_TIME;
    //     trap.push_back(fabs(REAL_VAL-int_trapezoidal(i,a,b,&f3))); 
    ...
    for(int i = 2; i<=8; i*=2){
        // start = GET_TIME;
        legend.push_back(REAL_VAL-legendre(i,&f3_legendre));
