...
# set terminal png nocrop font "/usr/share/fonts/dejavu/DejaVuSans.ttf,12" fontscale 1.0 size 640,480 
# set output 'cdf3.png'
unset clip points
set clip one
unset clip two
...
binwidth = 0.1
plot 'cdf3.dat' using (bin($1,binwidth)):(1.0) smooth freq with boxes
#    EOF
