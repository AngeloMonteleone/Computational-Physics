...
int main(int argc, char** argv){
    ...
    integrator<ld>(timestep,step_limit,{0,1},pars,{&f_theta,&f_zeta},"eulero.dat","eulero",0,{});
    integrator<ld>(timestep,step_limit,{0,1},pars,{&f_theta,&f_zeta},"rk2.dat","rk2",0,{});
    integrator<ld>(timestep,step_limit,{0,1},pars,{&f_theta,&f_zeta},"rk4.dat","rk4",0,{});
